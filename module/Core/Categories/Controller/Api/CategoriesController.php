...
namespace Module\Core\Categories\Controller\Api;

use Module\Core\Categories\Service\CategoriesService;
...
class CategoriesController
{
    ...
    #[Route('/{categoryId}', name: 'get_id', methods: ['GET'])]
    ...
    #[Route('/{categoryId}/upload-image', name: 'upload_image', methods: ['POST'])]
    ...
    #[Route('/{categoryId}/add-translation', name: 'add_translation', methods: ['POST'])]
    ...
    #[Route('/{categoryId}/update', name: 'update_id', methods: ['PUT'])]
    ...
    #[Route('/{categoryId}/update-translation/{translationId}', name: 'update_translation', methods: ['PUT'])]
    ...
    #[Route('/{categoryId}/delete-translation/{translationId}', name: 'delete_translation', methods: ['DELETE'])]
