 ...
 */
final class Version20241124131759 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE module_charities_missionstatement (MissionStatementID INT AUTO_INCREMENT NOT NULL, CreatedDate DATETIME NOT NULL, MissionStatementCode VARCHAR(255) NOT NULL, PRIMARY KEY(MissionStatementID)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE module_charities_missionstatement_translations (MissionStatementTranslationID INT AUTO_INCREMENT NOT NULL, LanguageID INT NOT NULL, MissionStatementName VARCHAR(100) NOT NULL, MissionStatementDescription LONGTEXT DEFAULT NULL, MissionStatementID INT NOT NULL, INDEX IDX_326B0BEB8E4BF6F7 (MissionStatementID), PRIMARY KEY(MissionStatementTranslationID)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('ALTER TABLE module_charities_missionstatement_translations ADD CONSTRAINT FK_326B0BEB8E4BF6F7 FOREIGN KEY (MissionStatementID) REFERENCES module_charities_missionstatement (MissionStatementID)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE module_charities_missionstatement_translations DROP FOREIGN KEY FK_326B0BEB8E4BF6F7');
        ...
        $this->addSql('DROP TABLE module_charities_missionstatement');
        $this->addSql('DROP TABLE module_charities_missionstatement_translations');
