 ...
 */
final class Version20241114134647 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE module_employees (EmployeeID INT AUTO_INCREMENT NOT NULL, EmployeeActive TINYINT(1) DEFAULT 0 NOT NULL, EmployeeLink VARCHAR(255) NOT NULL, EmployeeName VARCHAR(255) NOT NULL, EmployeeDescription LONGTEXT DEFAULT NULL, EmployeeLinkedIn VARCHAR(255) DEFAULT NULL, EmployeeInstagram VARCHAR(255) DEFAULT NULL, EmployeeFacebook VARCHAR(255) DEFAULT NULL, EmployeeTwitter VARCHAR(255) DEFAULT NULL, LanguageID INT NOT NULL, CategoryID INT NOT NULL, EmployeeJobTitleID INT NOT NULL, INDEX IDX_E0E3DCC8E03EAF66 (LanguageID), INDEX IDX_E0E3DCC8E8042869 (CategoryID), INDEX IDX_E0E3DCC8F599824F (EmployeeJobTitleID), PRIMARY KEY(EmployeeID)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE module_marital_status (MaritalStatusID INT AUTO_INCREMENT NOT NULL, CreatedDate DATETIME NOT NULL, MaritalStatusCode VARCHAR(255) NOT NULL, PRIMARY KEY(MaritalStatusID)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE module_marital_status_translations (MaritalStatusTranslationID INT AUTO_INCREMENT NOT NULL, MaritalStatusName VARCHAR(100) NOT NULL, MaritalStatusID INT NOT NULL, LanguageID INT NOT NULL, INDEX IDX_F99C14E2306AA9F (MaritalStatusID), INDEX IDX_F99C14E2E03EAF66 (LanguageID), PRIMARY KEY(MaritalStatusTranslationID)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('ALTER TABLE module_marital_status_translations ADD CONSTRAINT FK_F99C14E2306AA9F FOREIGN KEY (MaritalStatusID) REFERENCES module_marital_status (MaritalStatusID)');
        $this->addSql('ALTER TABLE module_marital_status_translations ADD CONSTRAINT FK_F99C14E2E03EAF66 FOREIGN KEY (LanguageID) REFERENCES module_languages (LanguageID)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE module_marital_status_translations DROP FOREIGN KEY FK_F99C14E2306AA9F');
        $this->addSql('ALTER TABLE module_marital_status_translations DROP FOREIGN KEY FK_F99C14E2E03EAF66');
        ...
        $this->addSql('DROP TABLE module_marital_status');
        $this->addSql('DROP TABLE module_marital_status_translations');
    }
}
