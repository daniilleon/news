 ...
 */
final class Version20241106135253 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE module_employees (EmployeeID INT AUTO_INCREMENT NOT NULL, EmployeeLink VARCHAR(255) NOT NULL, EmployeeName VARCHAR(255) NOT NULL, EmployeeJobTitle VARCHAR(255) NOT NULL, EmployeeDescription LONGTEXT DEFAULT NULL, EmployeeLinkedIn VARCHAR(255) DEFAULT NULL, EmployeeInstagram VARCHAR(255) DEFAULT NULL, EmployeeFacebook VARCHAR(255) DEFAULT NULL, EmployeeTwitter VARCHAR(255) DEFAULT NULL, LanguageID INT NOT NULL, CategoryID INT NOT NULL, INDEX IDX_E0E3DCC8E03EAF66 (LanguageID), INDEX IDX_E0E3DCC8E8042869 (CategoryID), PRIMARY KEY(EmployeeID)) DEFAULT CHARACTER SET utf8mb4');
