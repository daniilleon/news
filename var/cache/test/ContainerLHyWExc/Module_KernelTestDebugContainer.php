 ...
 */
class Module_KernelTestDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'Module\\Employees\\Controller\\Api\\EmployeesController' => 'getEmployeesControllerService',
            'Module\\Languages\\Controller\\Api\\LanguagesController' => 'getLanguagesControllerService',
    ...
    protected static function getDebug_ControllerResolver_InnerService($container)
    {
        ...
        $instance->allowControllers(['Module\\Kernel', 'Module\\Employees\\Controller\\Api\\EmployeesController', 'Module\\Languages\\Controller\\Api\\LanguagesController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    private function getDynamicParameter(string $name)
    {
        ...
        $value = match ($name) {
            ...
            'debug.container.dump' => ($container->targetDir.''.'/Module_KernelTestDebugContainer.xml'),
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.container_class' => 'Module_KernelTestDebugContainer',
