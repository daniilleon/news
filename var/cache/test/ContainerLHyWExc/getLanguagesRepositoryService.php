 ...
 */
class getLanguagesRepositoryService extends Module_KernelTestDebugContainer
{
    /**
     * Gets the private 'Module\Languages\Repository\LanguagesRepository' shared autowired service.
     *
     * @return \Module\Languages\Repository\LanguagesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'module'.\DIRECTORY_SEPARATOR.'Languages'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'LanguagesRepository.php';

        $a = ($container->services['doctrine.orm.default_entity_manager'] ?? $container->load('getDoctrine_Orm_DefaultEntityManagerService'));

        if (isset($container->privates['Module\\Languages\\Repository\\LanguagesRepository'])) {
            return $container->privates['Module\\Languages\\Repository\\LanguagesRepository'];
        }

        return $container->privates['Module\\Languages\\Repository\\LanguagesRepository'] = new \Module\Languages\Repository\LanguagesRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')), $a);
    }
}
