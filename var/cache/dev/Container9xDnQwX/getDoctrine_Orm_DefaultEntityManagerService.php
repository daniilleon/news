...
class getDoctrine_Orm_DefaultEntityManagerService extends Module_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $c = ($container->privates['doctrine.orm.default_attribute_metadata_driver'] ??= new \Doctrine\ORM\Mapping\Driver\AttributeDriver([(\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'module'.\DIRECTORY_SEPARATOR.'Languages'.\DIRECTORY_SEPARATOR.'Entity'), (\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'module'.\DIRECTORY_SEPARATOR.'Employees'.\DIRECTORY_SEPARATOR.'Entity')], true));

        $b->addDriver($c, 'Module\\Languages\\Entity');
        $b->addDriver($c, 'Module\\Employees\\Entity');

        $a->setEntityNamespaces(['LanguagesModule' => 'Module\\Employees\\Entity']);
