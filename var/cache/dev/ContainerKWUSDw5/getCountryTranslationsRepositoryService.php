 ...
 */
class getCountryTranslationsRepositoryService extends Module_KernelDevDebugContainer
{
    /**
     * Gets the private 'Module\Core\Countries\Repository\CountryTranslationsRepository' shared autowired service.
     *
     * @return \Module\Core\Countries\Repository\CountryTranslationsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'module'.\DIRECTORY_SEPARATOR.'Core'.\DIRECTORY_SEPARATOR.'Countries'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CountryTranslationsRepository.php';

        $a = ($container->services['doctrine.orm.default_entity_manager'] ?? $container->load('getDoctrine_Orm_DefaultEntityManagerService'));

        if (isset($container->privates['Module\\Core\\Countries\\Repository\\CountryTranslationsRepository'])) {
            return $container->privates['Module\\Core\\Countries\\Repository\\CountryTranslationsRepository'];
        }

        return $container->privates['Module\\Core\\Countries\\Repository\\CountryTranslationsRepository'] = new \Module\Core\Countries\Repository\CountryTranslationsRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')), $a);
    }
}
