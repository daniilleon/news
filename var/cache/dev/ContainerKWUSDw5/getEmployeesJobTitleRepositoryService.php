 ...
 */
class getEmployeesJobTitleRepositoryService extends Module_KernelDevDebugContainer
{
    /**
     * Gets the private 'Module\Employees\EmployeesJobTitle\Repository\EmployeesJobTitleRepository' shared autowired service.
     *
     * @return \Module\Employees\EmployeesJobTitle\Repository\EmployeesJobTitleRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'module'.\DIRECTORY_SEPARATOR.'Employees'.\DIRECTORY_SEPARATOR.'EmployeesJobTitle'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'EmployeesJobTitleRepository.php';

        $a = ($container->services['doctrine.orm.default_entity_manager'] ?? $container->load('getDoctrine_Orm_DefaultEntityManagerService'));

        if (isset($container->privates['Module\\Employees\\EmployeesJobTitle\\Repository\\EmployeesJobTitleRepository'])) {
            return $container->privates['Module\\Employees\\EmployeesJobTitle\\Repository\\EmployeesJobTitleRepository'];
        }

        return $container->privates['Module\\Employees\\EmployeesJobTitle\\Repository\\EmployeesJobTitleRepository'] = new \Module\Employees\EmployeesJobTitle\Repository\EmployeesJobTitleRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')), $a);
    }
}
