 ...
 */
class getEmployeesRepositoryService extends Module_KernelDevDebugContainer
{
    /**
     * Gets the private 'Module\Employees\Employees\Repository\EmployeesRepository' shared autowired service.
     *
     * @return \Module\Employees\Employees\Repository\EmployeesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'module'.\DIRECTORY_SEPARATOR.'Employees'.\DIRECTORY_SEPARATOR.'Employees'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'EmployeesRepository.php';

        $a = ($container->services['doctrine.orm.default_entity_manager'] ?? $container->load('getDoctrine_Orm_DefaultEntityManagerService'));

        if (isset($container->privates['Module\\Employees\\Employees\\Repository\\EmployeesRepository'])) {
            return $container->privates['Module\\Employees\\Employees\\Repository\\EmployeesRepository'];
        }

        return $container->privates['Module\\Employees\\Employees\\Repository\\EmployeesRepository'] = new \Module\Employees\Employees\Repository\EmployeesRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')), $a, ($container->privates['monolog.logger'] ?? $container->load('getMonolog_LoggerService')));
    }
}
