 ...
 */
class getCategoriesRepositoryService extends Module_KernelDevDebugContainer
{
    /**
     * Gets the private 'Module\Core\Categories\Repository\CategoriesRepository' shared autowired service.
     *
     * @return \Module\Core\Categories\Repository\CategoriesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'module'.\DIRECTORY_SEPARATOR.'Core'.\DIRECTORY_SEPARATOR.'Categories'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CategoriesRepository.php';

        $a = ($container->services['doctrine.orm.default_entity_manager'] ?? $container->load('getDoctrine_Orm_DefaultEntityManagerService'));

        if (isset($container->privates['Module\\Core\\Categories\\Repository\\CategoriesRepository'])) {
            return $container->privates['Module\\Core\\Categories\\Repository\\CategoriesRepository'];
        }

        return $container->privates['Module\\Core\\Categories\\Repository\\CategoriesRepository'] = new \Module\Core\Categories\Repository\CategoriesRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')), $a);
    }
}
