 ...
 */
class getMaritalStatusTranslationsRepositoryService extends Module_KernelDevDebugContainer
{
    /**
     * Gets the private 'Module\Persons\MaritalStatus\Repository\MaritalStatusTranslationsRepository' shared autowired service.
     *
     * @return \Module\Persons\MaritalStatus\Repository\MaritalStatusTranslationsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'module'.\DIRECTORY_SEPARATOR.'Persons'.\DIRECTORY_SEPARATOR.'MaritalStatus'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MaritalStatusTranslationsRepository.php';

        $a = ($container->services['doctrine.orm.default_entity_manager'] ?? $container->load('getDoctrine_Orm_DefaultEntityManagerService'));

        if (isset($container->privates['Module\\Persons\\MaritalStatus\\Repository\\MaritalStatusTranslationsRepository'])) {
            return $container->privates['Module\\Persons\\MaritalStatus\\Repository\\MaritalStatusTranslationsRepository'];
        }

        return $container->privates['Module\\Persons\\MaritalStatus\\Repository\\MaritalStatusTranslationsRepository'] = new \Module\Persons\MaritalStatus\Repository\MaritalStatusTranslationsRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')), $a);
    }
}
