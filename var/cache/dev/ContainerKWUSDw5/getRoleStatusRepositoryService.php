 ...
 */
class getRoleStatusRepositoryService extends Module_KernelDevDebugContainer
{
    /**
     * Gets the private 'Module\Shared\RoleStatus\Repository\RoleStatusRepository' shared autowired service.
     *
     * @return \Module\Shared\RoleStatus\Repository\RoleStatusRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'module'.\DIRECTORY_SEPARATOR.'Shared'.\DIRECTORY_SEPARATOR.'RoleStatus'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'RoleStatusRepository.php';

        $a = ($container->services['doctrine.orm.default_entity_manager'] ?? $container->load('getDoctrine_Orm_DefaultEntityManagerService'));

        if (isset($container->privates['Module\\Shared\\RoleStatus\\Repository\\RoleStatusRepository'])) {
            return $container->privates['Module\\Shared\\RoleStatus\\Repository\\RoleStatusRepository'];
        }

        return $container->privates['Module\\Shared\\RoleStatus\\Repository\\RoleStatusRepository'] = new \Module\Shared\RoleStatus\Repository\RoleStatusRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')), $a);
    }
}
