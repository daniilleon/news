 ...
 */
class getEducationLevelTranslationsRepositoryService extends Module_KernelDevDebugContainer
{
    /**
     * Gets the private 'Module\Persons\EducationLevels\Repository\EducationLevelTranslationsRepository' shared autowired service.
     *
     * @return \Module\Persons\EducationLevels\Repository\EducationLevelTranslationsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'module'.\DIRECTORY_SEPARATOR.'Persons'.\DIRECTORY_SEPARATOR.'EducationLevels'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'EducationLevelTranslationsRepository.php';

        $a = ($container->services['doctrine.orm.default_entity_manager'] ?? $container->load('getDoctrine_Orm_DefaultEntityManagerService'));

        if (isset($container->privates['Module\\Persons\\EducationLevels\\Repository\\EducationLevelTranslationsRepository'])) {
            return $container->privates['Module\\Persons\\EducationLevels\\Repository\\EducationLevelTranslationsRepository'];
        }

        return $container->privates['Module\\Persons\\EducationLevels\\Repository\\EducationLevelTranslationsRepository'] = new \Module\Persons\EducationLevels\Repository\EducationLevelTranslationsRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')), $a);
    }
}
