 ...
 */
class getIndustriesRepositoryService extends Module_KernelDevDebugContainer
{
    /**
     * Gets the private 'Module\Shared\Industries\Repository\IndustriesRepository' shared autowired service.
     *
     * @return \Module\Shared\Industries\Repository\IndustriesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'module'.\DIRECTORY_SEPARATOR.'Shared'.\DIRECTORY_SEPARATOR.'Industries'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'IndustriesRepository.php';

        $a = ($container->services['doctrine.orm.default_entity_manager'] ?? $container->load('getDoctrine_Orm_DefaultEntityManagerService'));

        if (isset($container->privates['Module\\Shared\\Industries\\Repository\\IndustriesRepository'])) {
            return $container->privates['Module\\Shared\\Industries\\Repository\\IndustriesRepository'];
        }

        return $container->privates['Module\\Shared\\Industries\\Repository\\IndustriesRepository'] = new \Module\Shared\Industries\Repository\IndustriesRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')), $a);
    }
}
